...
const MainContent2 = ({groupedItems, onSelectItem, style }) => {
  ...
  return <div style={{...style, position: 'relative', width: 1580, height: 900 }}>
    ...
    <VerticalCategory {...cat6} cols={6} width={240} height={710} top={0} left={1030} color="rgb(130, 207, 231)" onSelectItem={onSelectItem} />
    <VerticalCategory {...cat7} cols={7} width={280} height={525} top={0} left={1280} color="rgb(142, 209, 216)" onSelectItem={onSelectItem} />
    <HorizontalCategory {...cat8} rows={4} width={740} height={160} top={720} left={820} color="rgb(124, 200, 182)" onSelectItem={onSelectItem} />
    <LandscapeInfo width={390} height={160} top={720} left={370}>
