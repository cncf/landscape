...
const MainContent2 = ({groupedItems, onSelectItem, style, zoom }) => {
  ...
  return <div style={{...style, position: 'relative', width: 920, height: 640 }}>
    ...
    <LandscapeInfo width={360} height={160} top={300} left={465} zoom={zoom}>
      This landscape is intended as a map to explore open source projects covering artificial intelligence, machine learning and deep learning. It includes projects hosted under the LF Deep Learning Foundation and a list of its member companies.
    </LandscapeInfo>
