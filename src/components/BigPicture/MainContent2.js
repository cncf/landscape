...
const MainContent2 = ({groupedItems, onSelectItem, style, showPreview, switchToServerless, zoom }) => {
  ...
  return <div style={{...style, position: 'relative', width: 1620, height: 900 }}>
    ...
    <HorizontalCategory {...cat2} rows={3} width={1050} height={140} top={240} left={0} zoom={zoom} color="rgb(104, 145, 145)" fitWidth onSelectItem={onSelectItem} />
    ...
    <HorizontalCategory {...cat8} rows={4} width={780} height={160} top={720} left={820} zoom={zoom} color="rgb(124, 200, 182)" onSelectItem={onSelectItem} />
    <LandscapeInfo width={390} height={160} top={720} left={330} zoom={zoom}>
